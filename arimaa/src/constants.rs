...
pub const PHASE_NUM_CHANNELS: usize = 1;
pub const PHASE_CHANNEL_IDX: usize = BANNED_PIECES_CHANNEL_IDX + BANNED_PIECES_NUM_CHANNELS;
pub const TRAP_NUM_CHANNELS: usize = 1;
pub const TRAP_CHANNEL_IDX: usize = PHASE_CHANNEL_IDX + PHASE_NUM_CHANNELS;
pub const INPUT_H: usize = BOARD_HEIGHT;
pub const INPUT_W: usize = BOARD_WIDTH;
pub const INPUT_C: usize = BOARD_PIECES_NUM_CHANNELS
    + STEP_NUM_CHANNELS
    + BANNED_PIECES_NUM_CHANNELS
    + PHASE_NUM_CHANNELS
    + TRAP_NUM_CHANNELS;
...
pub const PLACE_MOVES: usize = 16;

pub const OUTPUT_SIZE: usize = NUM_PIECE_MOVES + NUM_PUSH_PULL_MOVES + PASS_MOVES + PLACE_MOVES;
