...
pub const TRAP_CHANNEL_IDX: usize = STEP_NUM_CHANNEL_IDX + STEP_NUM_CHANNELS;
pub const PLAY_INPUT_H: usize = BOARD_HEIGHT;
pub const PLAY_INPUT_W: usize = BOARD_WIDTH;
pub const PLAY_INPUT_C: usize = BOARDS_PER_STATE + STEP_NUM_CHANNELS + VALID_MOVES_NUM_CHANNELS + TRAP_CHANNELS;
