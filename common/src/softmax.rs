...
mod test {
    ...
    fn test_softmax_temp_1() {
        ...
        let temperature = 1.0;
        let expected = [0.231129, 0.255437, 0.282302, 0.231129];
    ...
    fn test_softmax_temp_1_1() {
        let logits = vec![0.1, 0.2, 0.3, 0.1];
        let temperature = 1.1;
        let expected = [0.232852, 0.255012, 0.279282, 0.232852];
        let actual = softmax(&logits, temperature);
    ...
    fn test_softmax_temp_1_2() {
        let logits = vec![0.1, 0.2, 0.3, 0.1];
        let temperature = 1.2;
        let expected = [0.234287, 0.254647, 0.276777, 0.234287];
        let actual = softmax(&logits, temperature);
    ...
    fn test_softmax_temp_one_0() {
        ...
        let temperature = 1.2;
        let expected = [0.160817, 0.516429, 0.174793, 0.147959];
        let actual = softmax(&logits, temperature);
