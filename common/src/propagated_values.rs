...
pub struct VictoryMarginPropagatedValue {
    value: f32,
    game_length: f32,
    victory_margin: f32,
    num_updates: usize,
...
impl VictoryMarginPropagatedValue {
...
impl PropagatedValue for VictoryMarginPropagatedValue {
    fn value(&self) -> f32 {
        self.value
    }
}

impl PropagatedGameLength for VictoryMarginPropagatedValue {
    fn game_length(&self) -> f32 {
        self.game_length
    }
}

impl Eq for VictoryMarginPropagatedValue {}

impl Ord for VictoryMarginPropagatedValue {
...
impl PartialOrd for VictoryMarginPropagatedValue {
